...
const config = {
  "generator": {
    ...
    "output": {
      "value": "C:\\Users\\Acer Predator\\Documents\\agiles\\PROYECT2\\packages\\database\\src\\ticket-client",
      "fromEnvVar": null
    },
    "config": {
      "engineType": "library"
...
path.join(process.cwd(), "src/ticket-client/query_engine-windows.dll.node")
// file annotations for bundling tools to include these files
path.join(__dirname, "schema.prisma");
path.join(process.cwd(), "src/ticket-client/schema.prisma")
