...
const config = {
  "generator": {
    ...
    "output": {
      "value": "C:\\Users\\Acer Predator\\Documents\\agiles\\PROYECT2\\packages\\database\\auth-client",
      "fromEnvVar": null
    },
    "config": {
      "engineType": "library"
  ...
  "inlineSchemaHash": "c6f7ecbee8d5e8f13946951c36692f4a3cca874dc7476cb80dffebfa183336ea",
  "copyEngine": true
}
...
path.join(process.cwd(), "packages/database/auth-client/query_engine-windows.dll.node")
// file annotations for bundling tools to include these files
path.join(__dirname, "schema.prisma");
path.join(process.cwd(), "packages/database/auth-client/schema.prisma")
